...
Este foi um projeto realizado para a loja na qual eu trabalhava, onde precisavamos catalogar alguns produtos que não estavam disponíveis pra venda por conta de algumas situações adversas, como por exemplo itens com Defeito, em "Quarentena"(quando se encontra divergência de quantidade entre estoque físico e o estoque virtual), produtos para "Exposição" e produtos "Desparceirados" (quando um item do par está faltando).
